...
#include "Sound.h"
#include "PolyhedronOpenAL/AL/efx-presets.h"

#if USE_FIXED_LIBAL
#include "PolyhedronOpenAL/fixed.h"
#else
#include "PolyhedronOpenAL/dynamic.h"
#endif
...
static void AL_AddLoopSounds(void)
{
	...
	if (cls.connectionState != ClientConnectionState::Active || sv_paused->integer || !s_ambient->integer) {
		return;
	}

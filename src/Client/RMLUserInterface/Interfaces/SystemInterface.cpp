...
//=============================================================================
//
Rml::Input::KeyIdentifier RmlUISystemInterface::TranslateKey(SDL_Keycode sdlkey)
{
...
//=============================================================================
//
int RmlUISystemInterface::TranslateMouseButton(Uint8 button)
{
    switch (button)
    {
...
//=============================================================================
//
int RmlUISystemInterface::GetKeyModifiers()
{

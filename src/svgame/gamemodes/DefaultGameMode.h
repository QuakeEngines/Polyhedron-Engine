...
public:
    ...
    //
    virtual qboolean GetServerEntityTeamName(ServerGameEntity* ent, std::string &teamName) override;
    ...
    //
    virtual void ServerEntityKilled(ServerGameEntity* target, ServerGameEntity* inflictor, ServerGameEntity* attacker, int32_t damage, vec3_t point) override;
